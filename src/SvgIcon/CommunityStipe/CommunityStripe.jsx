	...
	return (
		<SvgIcon {...props} titleAccess='community-stripe' viewBox='0 0 103 107'>
			<g fill='#FFF' fillRule='evenodd' transform='translate(.024 .775)'>
				...
				<circle cx='50.98' cy='10.2' r='10.2' fillOpacity='.5'></circle>
				<circle cx='50.98' cy='95.46' r='10.2' fillOpacity='.5'></circle>
				...
				<circle cx='91.76' cy='52.83' r='10.2' fillOpacity='.5'></circle>
			</g>
		</SvgIcon>
	);
};
