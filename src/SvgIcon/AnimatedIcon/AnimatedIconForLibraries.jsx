...
let AnimatedIconForLibraries = (props) => {
	return (
		<SvgIcon
			{...props}
			titleAccess='AnimatedIconForLibraries'
			width='96'
			height='96'
			...
			<use href='#terminalIconCode' fill='#7a73ff'></use>
			<use fill='#0a2540'></use>
			<use href='#terminalIconGear' fill='#00d4ff' transform-origin='42 55'></use>
			<g clipPath='url(#terminalIconClipPath)'>
				<use href='#terminalIconGear' fill='#cff' transform-origin='42 55'></use>
			</g>
		</SvgIcon>
	);
};

AnimatedIconForLibraries = styled(AnimatedIconForLibraries, { name: 'AnimatedIconForLibraries' })(({ theme }) => ({
	width: '96px',
	height: '96px'
}));
export default AnimatedIconForLibraries;
