...
let DiscoverCardIcon = (props) => {
	return (
		<SvgIcon {...props} titleAccess='discover logo' viewBox='0 0 17 12'>
			<path
				fill='#FFF'
				stroke='#000'
				strokeOpacity='.2'
				strokeWidth='.5'
				d='M15.58 11.75c.68 0 1.24-.55 1.24-1.24V1.4c0-.32-.14-.64-.37-.87a1.22 1.22 0 0 0-.87-.36H1.42C1.09.18.78.3.55.53a1.3 1.3 0 0 0-.37.89v9.09c0 .32.14.64.37.88.23.23.54.36.87.36h14.16z'></path>
			...
			<path
				fill='#F27712'
				d='M8.79 4.5c-.64 0-1.17.52-1.17 1.15 0 .68.5 1.2 1.17 1.2.66 0 1.18-.52 1.18-1.18 0-.65-.51-1.17-1.18-1.17z'></path>
		</SvgIcon>
	);
};

DiscoverCardIcon = styled(DiscoverCardIcon, { name: 'discover-card' })(({ theme }) => ({
	width: '17px',
	height: '12px',
	borderRadius: '4px',
