...
const WarbyParkerCheckoutGraphic = styled(Box, { name: 'warby-checkout-graphic' })(({ theme }) => ({
	...
	// --warbyTitleColor: #425466;
	//   --warbyTextColor: #687792;
}));
				...
				<WarbyParkerCheckoutGraphic>
					...
					<WarbyParkerCheckoutGraphicSection>
						...
						<Typography variant='WarbyParkerCheckoutGraphic__description' component='div'>
							What do you get when you combine round lenses, slim temple arms, and a keyhole bridge? A good-looking
							frame named Haskell.
						</Typography>
					...
					<WarbyParkerCheckoutGraphicSection>
						...
						<WarbyParkerCheckoutGraphicSectionRecommendProduct>
							...
							<Box gridArea='text' sx={{ display: 'flex', alignItems: 'center', gap: '5px', flexGrow: 1 }}>
								<Typography variant='WarbyParkerCheckoutGraphic__sectionTitle'>Percey</Typography>
								<Typography variant='WarbyParkerCheckoutGraphic__description' component='div'>
									Rye Tortoise
								</Typography>
							</Box>
						...
						<WarbyParkerCheckoutGraphicSectionRecommendProduct>
							...
							/>
							<Box gridArea='text' sx={{ display: 'flex', alignItems: 'center', gap: '5px', flexGrow: 1 }}>
								<Typography variant='WarbyParkerCheckoutGraphic__sectionTitle'>Durand</Typography>
								<Typography variant='WarbyParkerCheckoutGraphic__description' component='div'>
									Crystal
								</Typography>
							</Box>
						...
						<WarbyParkerCheckoutGraphicSectionRecommendProduct>
							...
							/>
							<Box gridArea='text' sx={{ display: 'flex', alignItems: 'center', gap: '5px', flexGrow: 1 }}>
								<Typography variant='WarbyParkerCheckoutGraphic__sectionTitle'>Felix</Typography>
								<Typography variant='WarbyParkerCheckoutGraphic__description' component='div'>
									Chamomile Fade
								</Typography>
							</Box>
